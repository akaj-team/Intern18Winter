...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.EmployeeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EmployeeViewHolder holder, int position) {
        holder.mTvIdEmployee.setText(String.valueOf(mEployee.get(position).getEmployeeId()));
        holder.mTvNameEmployee.setText(mEployee.get(position).getEmployeeName());
    }
    ...
    class EmployeeViewHolder extends RecyclerView.ViewHolder {
        ...
        EmployeeViewHolder(View itemView) {
            ...
            mTvIdEmployee.setOnClickListener(v -> mOnClickEmployee.onSelectEmployee(getAdapterPosition()));
